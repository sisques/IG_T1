...
list<shared_ptr<figura>> scene_1_(){
    ...
    materialProperties glass = materialProperties(false, eventos, refraction, GLASS);
...
list<shared_ptr<figura>> scene_4_(){
...
int main(int argc, char *argv[]){
    ...
    if(argc != 5){
        cout << "Parametros: rayos por pixel, anchura imagen, altura imagen, nombre imagen" << endl;
        return 0;
    }
